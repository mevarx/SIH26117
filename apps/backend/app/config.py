...
class Settings(BaseSettings):
    ...
    ollama_model: str = "hf.co/bloomer010/Ling-3.0-tiny-GGUF:Q4_K_M"
    ollama_fallback_model: str = "hf.co/bloomer010/Ling-3.0-tiny-GGUF:IQ2_M"

    # Multi-Model Role Configurations
    orchestrator_model: str = "hf.co/bloomer010/Ling-3.0-tiny-GGUF:Q4_K_M"
    orchestrator_fallback_model: str = "hf.co/bloomer010/Ling-3.0-tiny-GGUF:IQ2_M"
    router_model: str = "hf.co/bloomer010/Ling-3.0-tiny-GGUF:IQ2_M"
    asr_model: str = "hf.co/ggml-org/Qwen3-ASR-1.7B-GGUF:Q8_0"
    default_vision_model: str = "hf.co/unsloth/Qwen2.5-VL-3B-Instruct-GGUF:Q4_K_M"
    default_coding_model: str = "hf.co/bloomer010/Ling-3.0-tiny-GGUF:Q4_K_M"
    default_embedding_model: str = "nomic-embed-text"
    legacy_orchestrator_model: str = "ornith-1.5:9b-q4_k_m"
